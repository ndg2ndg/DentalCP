...
<div class="cover" id="cover">
  <img id="cover-img" src="" alt="" style="display:none" onerror="this.style.display='none'"/>
...
function renderHours(data) {
  ...
  hours.forEach(h => {
    ...
    tr.innerHTML = `<td>${dayName}</td><td>
      ${h.isOpen ? `<span class="open-dot${isToday ? "" : ""}"></span>` : `<span class="open-dot closed-dot"></span>`}
      ${timeStr}
    </td>`;
